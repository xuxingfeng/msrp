...
public class TestWrappedMessage {
	...
	private ByteBuffer buffer = ByteBuffer.wrap(cpimMessage.getBytes(TextUtils.utf8), 0, cpimMessage.getBytes(TextUtils.utf8).length);
	...
	public void testParse() {
		...
		try {
			System.out.println(new String(msg.getMessageContent(),"UTF-8"));
